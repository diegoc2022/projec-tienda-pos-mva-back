...
export class EditaPreciosController {
    ...
    @Patch('codigo/:id')
    async funct_edita_codigo_producto_c(@Param('id') id:string, @Body() codigo:EditaProductosDto){
        return await this.editaPreciosService.funct_edita_codigo_producto_s(id,codigo);
    }  
