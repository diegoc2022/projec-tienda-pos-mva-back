    ...
    async funct_registra_ventas_x_cobrar(
        ...
        await this.dataSource.transaction(async (manager) => {
          for (const item of data) {
            ...
            // Formatear la fecha que viene del calendario (formato ISO)
            const fechaFormateada = formatearFechaDDMMYYYY(item.fecha_registro);
            // O si prefieres formato SQL: const fechaFormateada = extraerSoloFecha(item.fecha_registro);
            ...
            const venta = {
              ...
              num_mes:this.mes,
              num_year:this.year,
              fecha_registro: fechaFormateada, // Usar la fecha formateada
