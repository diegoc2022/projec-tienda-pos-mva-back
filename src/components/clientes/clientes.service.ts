...
export class ClientesService {
    ...
    async funct_registra_clientes_s(data:any){
        ...
        // Si recibes una fecha del calendario en formato ISO, puedes formatearla así:
        // const fechaCalendario = formatearFechaDDMMYYYY(data.fecha_calendario);
        // O para formato SQL: const fechaCalendario = extraerSoloFecha(data.fecha_calendario);
